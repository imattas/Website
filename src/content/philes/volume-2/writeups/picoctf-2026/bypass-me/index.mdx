...
- [Ghidra](https://ghidra-sre.org/) — open-source reverse engineering / decompiler suite
- [angr](https://angr.io/) — binary analysis and symbolic execution framework
- [radare2](https://rada.re/n/) — reversing and binary patching toolkit
- [pwntools `checksec`](https://docs.pwntools.com/) — binary protection inspection
