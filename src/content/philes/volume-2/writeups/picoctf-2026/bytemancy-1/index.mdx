...
- [Python `struct` documentation](https://docs.python.org/3/library/struct.html) — endianness and byte packing
- [Python bitwise operations](https://docs.python.org/3/reference/expressions.html#binary-bitwise-operations) — XOR, shifts, masks
- [pwntools documentation](https://docs.pwntools.com/) — `remote`, `sendline`, payload delivery
