...
- [Franklin-Reiter related-message attack — Wikipedia (Coppersmith's attack)](https://en.wikipedia.org/wiki/Coppersmith%27s_attack#Franklin-Reiter_related-message_attack)
- [SageMath documentation](https://doc.sagemath.org/)
- [SymPy Polynomials documentation](https://docs.sympy.org/latest/modules/polys/index.html)
