...
- [systemd / systemctl documentation](https://www.freedesktop.org/software/systemd/man/systemctl.html) — service and unit management
- [Paramiko documentation](https://docs.paramiko.org/) — Python SSH automation
- [journalctl documentation](https://www.freedesktop.org/software/systemd/man/journalctl.html) — querying systemd logs
