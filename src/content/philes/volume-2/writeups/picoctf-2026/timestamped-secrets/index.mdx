...
- [PyCryptodome documentation](https://pycryptodome.readthedocs.io/) — AES, ECB mode, PKCS#7 padding
- [CryptoHack — AES / ECB](https://cryptohack.org/) — block cipher mode weaknesses
- [Wikipedia — PKCS#7 padding](https://en.wikipedia.org/wiki/Padding_(cryptography)#PKCS#5_and_PKCS#7)
