...
- [Volatility 3](https://github.com/volatilityfoundation/volatility3) — Linux memory forensics framework
- [dwarf2json](https://github.com/volatilityfoundation/dwarf2json) — building a custom Volatility symbol table from `vmlinux` + `System.map`
- [Ghidra](https://ghidra-sre.org/) — disassembly/decompilation of the dumped code region
- [`memfd_create(2)`](https://man7.org/linux/man-pages/man2/memfd_create.2.html) — the anonymous in-memory file mechanism behind fileless execution
- [OpenWrt](https://openwrt.org/) — the router platform (procd/ujail/netifd, UCI dnsmasq config)
