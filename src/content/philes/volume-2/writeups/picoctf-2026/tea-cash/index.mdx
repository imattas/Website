...
- [how2heap — tcache examples (shellphish)](https://github.com/shellphish/how2heap)
- [glibc malloc internals / tcache overview (sourceware wiki)](https://sourceware.org/glibc/wiki/MallocInternals)
