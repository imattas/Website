...
- [factordb.com](http://factordb.com) — online integer factorization database
- [SymPy `factorint` documentation](https://docs.sympy.org/latest/modules/ntheory.html) — integer factorization in Python
- [yafu](https://github.com/bbuhrow/yafu) — automated integer factorization tool
