...
--[ repository ]------------------------------------------------------------
    ...
    URL      : https://github.com/imattas/idkCTF
    Language : TypeScript
    Status   : active
    Stars    : 0
    Updated  : 2026-06-17

Host CTFs on Cloudflare workers for free
...
| Database | **D1** (SQLite) — schema in [migrations/0001_init.sql](https://github.com/imattas/idkCTF/blob/main/migrations/0001_init.sql) |
