...
- [The Sleuth Kit](https://www.sleuthkit.org/sleuthkit/) — `fls`, `mactime`, `icat`, `mmls`, `fsstat`, `blkls`
- [The Sleuth Kit Wiki — Timeline Analysis](https://wiki.sleuthkit.org/index.php?title=Timeline)
