...
- [Python `struct` documentation](https://docs.python.org/3/library/struct.html) — `pack`/`unpack`, endianness
- [Python bitwise operations](https://docs.python.org/3/reference/expressions.html#binary-bitwise-operations) — XOR, shifts, masks
- [Python `bytes` documentation](https://docs.python.org/3/library/stdtypes.html#bytes) — raw byte handling and `sys.stdout.buffer`
