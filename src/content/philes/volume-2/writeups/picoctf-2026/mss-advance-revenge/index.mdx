...
- [Mignotte's threshold secret sharing scheme (Wikipedia)](https://en.wikipedia.org/wiki/Secret_sharing_using_the_Chinese_remainder_theorem)
- [Chinese Remainder Theorem (Wikipedia)](https://en.wikipedia.org/wiki/Chinese_remainder_theorem)
- [SymPy ntheory.modular.crt](https://docs.sympy.org/latest/modules/ntheory.html)
