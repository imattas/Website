...
- [MDN: XSLT / XSLTProcessor](https://developer.mozilla.org/en-US/docs/Web/XSLT)
- [Redis maxmemory & eviction policies](https://redis.io/docs/latest/develop/reference/eviction/)
