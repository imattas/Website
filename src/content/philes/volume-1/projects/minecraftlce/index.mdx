...
--[ repository ]------------------------------------------------------------
    ...
    URL      : https://github.com/imattas/MinecraftLCE
    Language : C++
    Status   : archived
    Stars    : 0
    Updated  : 2026-05-04
...
![Legacy Edition Banner](https://raw.githubusercontent.com/imattas/MinecraftLCE/main/.github/banner.png)
...
For more information, see [COMPILE.md](https://github.com/imattas/MinecraftLCE/blob/main/COMPILE.md).
