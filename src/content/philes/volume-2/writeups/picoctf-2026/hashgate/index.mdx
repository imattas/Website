...
- [PHP Magic Hashes (PayloadsAllTheThings)](https://github.com/swisskyrepo/PayloadsAllTheThings/tree/master/Type%20Juggling)
- [OWASP — PHP Type Juggling](https://owasp.org/www-pdf-archive/PHPMagicTricks-TypeJuggling.pdf)
- [PHP loose comparison tables](https://www.php.net/manual/en/types.comparisons.php)
