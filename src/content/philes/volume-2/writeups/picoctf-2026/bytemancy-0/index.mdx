...
- [Python `bytes` / `bytearray` documentation](https://docs.python.org/3/library/stdtypes.html#bytes) — `bytes.fromhex`, `hex()`, indexing
- [pwntools documentation](https://docs.pwntools.com/) — `remote`, `sendline`, `recvuntil`
