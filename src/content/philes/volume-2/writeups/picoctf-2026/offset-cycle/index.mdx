...
- [pwntools documentation](https://docs.pwntools.com/) — `cyclic`, `cyclic_find`, `ELF`, `ROP`, `process`/`remote`
- [pwntools cyclic / De Bruijn cheatsheet](https://docs.pwntools.com/en/stable/util/cyclic.html)
