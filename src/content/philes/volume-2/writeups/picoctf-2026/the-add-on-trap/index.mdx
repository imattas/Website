...
- [Chrome Extensions — manifest.json reference](https://developer.chrome.com/docs/extensions/reference/manifest)
- [MDN — Browser extensions (Anatomy of an extension)](https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/Anatomy_of_a_WebExtension)
- [CRX package format](https://developer.chrome.com/docs/extensions/how-to/distribute/host-on-linux)
