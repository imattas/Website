...
- [pwntools documentation](https://docs.pwntools.com/) — `fmtstr_payload`, `ELF`, `remote`/`process`
- [CTF 101: Format String Vulnerabilities](https://ctf101.org/binary-exploitation/what-is-a-format-string-vulnerability/) — concept primer
